...
import { hasSelectedProfile, validateCustomerData } from "@/utils/validators";
...
export const Route = createFileRoute("/onboarding/specific/")({
	component: MedicOnboardingPage,
	beforeLoad: ({ context }) => {
