...
export const Route = createFileRoute("/onboarding")({
	...
	head: () => ({
		meta: [
			{
				title: "Onboarding: Perfil | Clínica",
			},
		],
	}),
	beforeLoad: ({ context }) => {
...
function OnboardingLayout() {
	...
	const steps = [
		{ key: "profile", label: "Perfil", conclusionRate: "12%" },
		{ key: "personal", label: "Dados pessoais", conclusionRate: "38%" },
		{
			key: "specific",
			label: "Informações específicas",
			conclusionRate: "63%",
		},
		{ key: "submit", label: "Finalizar", conclusionRate: "88%" },
